...
const badgeColor = (status) => {
  switch (status) {
    ...
    case "confirmed":
      return "bg-gradient-to-r from-emerald-400 via-green-500 to-emerald-600 text-white shadow-lg shadow-gray-400/30 border border-green-300";

    case "cancelled":
      return "bg-gradient-to-r from-red-400 via-rose-500 to-red-600 text-white shadow-lg sshadow-gray-400/30 border border-red-300";
                    ...
                    >
                      ...
                      <TableCell>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-linear-to-r from-blue-500 to-cyan-500 text-sm font-bold text-white shadow-md">
