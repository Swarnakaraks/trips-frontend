            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-2xl bg-white/10 px-5 py-4 text-center backdrop-blur-md">
                  ...
                  <h2 className="text-2xl font-bold">{data?.length || 0}</h2>
                </div>

                <div className="rounded-2xl bg-white/10 px-5 py-4 text-center backdrop-blur-md">
                  <p className="text-xs uppercase text-blue-100">Pending</p>
                ...
                <div className="rounded-2xl bg-white/10 px-5 py-4 text-center backdrop-blur-md">
                  <p className="text-xs uppercase text-blue-100">Resolved</p>
                  <h2 className="text-2xl font-bold">
